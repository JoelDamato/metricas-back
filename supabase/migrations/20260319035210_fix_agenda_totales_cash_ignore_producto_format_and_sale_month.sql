-- Ajuste final de negocio para cash collected:
-- - debe sumar Venta y Cobranza
-- - producto_format vacio no impide contar cash
-- - el mes visualizado se define por f_acreditacion
-- - la particion agendas del mes / otros meses se define por fecha_de_agendamiento
-- - facturacion y ventas siguen usando solo filas de Venta
