-- Ajuste solicitado:
-- el cash de comprobantes debe salir de la columna cash_collected.
-- Se mantiene:
-- - mes visualizado por f_acreditacion
-- - separacion agendas del mes / otros meses por fecha_de_agendamiento
-- - facturacion y ventas solo con tipo Venta
