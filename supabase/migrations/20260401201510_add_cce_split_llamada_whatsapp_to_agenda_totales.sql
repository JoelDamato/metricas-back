create or replace view public.agenda_totales_base as
 ...
 SELECT
    ...
    count(*) FILTER (WHERE l.agendo = 'Agendo'::text AND l.aplica = 'Aplica'::text AND (l.call_confirm = 'Exitoso'::text OR l.llamada_cc = 'Exitoso'::text OR l.cc_whatsapp = 'Exitoso'::text)) AS cce,
    count(*) FILTER (WHERE l.agendo = 'Agendo'::text AND l.aplica = 'Aplica'::text AND (l.call_confirm = 'Exitoso'::text OR l.llamada_cc = 'Exitoso'::text OR l.cc_whatsapp = 'Exitoso'::text) AND l.llamada_meg = 'Efectuada'::text) AS cce_efectuadas,
    ...
    count(*) FILTER (WHERE l.agendo = 'Agendo'::text AND l.aplica = 'Aplica'::text AND (l.call_confirm = 'Exitoso'::text OR l.llamada_cc = 'Exitoso'::text)) AS cce_llamada,
    count(*) FILTER (WHERE l.agendo = 'Agendo'::text AND l.aplica = 'Aplica'::text AND l.cc_whatsapp = 'Exitoso'::text) AS cce_whatsapp
   FROM leads_raw l
