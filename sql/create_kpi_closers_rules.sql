...
create table if not exists public.kpi_closers_rules (
  ...
  cash_collected_3m_min numeric(10,2) not null default 100,
  cierre_llamada_weight numeric(10,2) not null default 20,
  asistencia_llamada_weight numeric(10,2) not null default 15,
  tasa_asistencia_weight numeric(10,2) not null default 15,
  tasa_cierre_weight numeric(10,2) not null default 20,
  cash_collected_weight numeric(10,2) not null default 15,
  cash_collected_3m_weight numeric(10,2) not null default 15,
