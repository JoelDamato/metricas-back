...
ALTER TABLE IF EXISTS csm ADD COLUMN IF NOT EXISTS f_diagnostico timestamptz;
...
ALTER TABLE IF EXISTS csm ADD COLUMN IF NOT EXISTS abandono text;
...
ALTER TABLE IF EXISTS csm ADD COLUMN IF NOT EXISTS engagement text;
