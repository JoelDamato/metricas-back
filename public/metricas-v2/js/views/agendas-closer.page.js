...
function buildKpis(rows) {
  ...
  wrap.innerHTML = `
    <article class="card"><h4>Total Leads</h4><p>${formatNumber(totals.total_leads)}</p></article>
    ...
    <article class="card"><h4>Facturación Total</h4><p>${formatCurrency(totals.facturacion_total)}</p></article>
    <article class="card"><h4>Cash Collected Total</h4><p>${formatCurrency(totals.cash_collected_total)}</p></article>
  `;
}
